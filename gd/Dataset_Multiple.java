...
public class Dataset_Multiple {
    ...
    */
    ...
    double x1[] = {4,6,8,4,10,1,9,5,2,7,8,2,2,8,7,9,1,4,6,9};//multiple
    double x2[] = {0.2,0.1,0.3,0.6,0.1,0.4,0.6,0.3,0.5,0.5,0.1,0.9,0.8,1,0.9,0.1,0.2,0.2,0.7,0.7};
    double y[] = {1.16,0.06,-1.79,1.55,-4.88,1.37,-1.25,-1.1,3.23,-2.71,-0.99,3.23,4.55,2.7,-1.13,-0.88,2.08,1.62,-0.9,0.46};
        //double alpha = 0.0005;
